...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-03-2024 a las 12:39:23
...
INSERT INTO `embarazo` (`id_embarazo`, `estado`, `puntuacion`) VALUES
(1, 'Emabarazada', 10),
(2, 'No aplica', 0);
...
INSERT INTO `historia_clinica` (`id_historia`, `id_usuario`, `id_patologia`, `fecha_ingreso`, `numero_folio`, `causa_ingreso`, `id_embarazo`) VALUES
...
ALTER TABLE `historia_clinica`
  ...
  ADD KEY `id_embarazo` (`id_embarazo`);
...
--
ALTER TABLE `embarazo`
  MODIFY `id_embarazo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `citas_agendadas`
  ADD CONSTRAINT `citas_agendadas_ibfk_1` FOREIGN KEY (`id_doctor`) REFERENCES `doctores` (`id_doctor`);
...
ALTER TABLE `historia_clinica`
  ...
  ADD CONSTRAINT `historia_clinica_ibfk_3` FOREIGN KEY (`id_embarazo`) REFERENCES `embarazo` (`id_embarazo`);

--
-- Filtros para la tabla `ordenamiento_precitas`
--
ALTER TABLE `ordenamiento_precitas`
  ADD CONSTRAINT `ordenamiento_precitas_ibfk_1` FOREIGN KEY (`id_preagendamiento`) REFERENCES `preagendamiento` (`id_preagendamiento`);
