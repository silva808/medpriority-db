...
// });
  ...
  // inputs
  var tipoDocumentoInput = document.querySelectorAll('id_type_');
  var numeroDocumentoInput = document.querySelectorAll('id_');
  var nombreInput = document.querySelectorAll('name_');
  var edadInput = document.querySelectorAll('age_');
  var sexoInput = document.querySelectorAll('sexmoneyfeelingsdie_');
  var direccionInput = document.querySelectorAll('address_');
  var telefonoInput = document.querySelectorAll('pickupyophonebaby_');
  var correoElectronicoInput = document.querySelectorAll('email_');
  var tipoAfiliacionInput = document.querySelectorAll('afi_');
